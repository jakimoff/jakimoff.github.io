...
!function(e){"use strict";function g(e){return e.slice(0,e.lastIndexOf("#"))}var n={init:function(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{},t={callback:e.callback,easing:e.easing||"linear",offset:e.offset||0,speed:e.speed||1e3,time:e.time||500,type:e.type||"speed"};n.scroll(t)}};n.scroll=function(i){function a(e){var t,n,o;w||(w=e),f=function(e,t,n,o,i){switch(i.easing){case"linear":return n*e/o+t;case"easeInOutQuad":return(e/=o/2)<1?n/2*e*e+t:-n/2*(--e*(e-2)-1)+t;case"easeInOutCubic":return(e/=o/2)<1?n/2*e*e*e+t:n/2*((e-=2)*e*e+2)+t}}(c=e-w,v,s,r,i),window.scrollTo(0,f),c<r?window.requestAnimationFrame(a):(t=v,n=s,o=i,window.scrollTo(0,t+n),"function"==typeof o.callback&&o.callback())}var s=void 0,r=void 0,c=void 0,d=void 0,l=void 0,u=void 0,f=void 0,v=void 0,w=void 0,p=void 0;document.body.addEventListener("click",function(e){var t,n,o;n=e.target,o=location.hash?g(location.href):location.href,"a"===n.tagName.toLowerCase()&&0<n.hash.length&&g(n.href)===o&&(e.preventDefault(),e.stopPropagation(),u=e.target.attributes.href.value.toString(),l=u.substr(u.lastIndexOf("#")+1),(d=document.getElementById(l))&&(v=window.scrollY||window.pageYOffset,t=v,p=d.getBoundingClientRect().top+t,s=p-v-i.offset,"speed"===i.type?r=1e3*Math.abs(s/i.speed):"time"===i.type&&(r=time)),window.requestAnimationFrame(function(e){a(w=e)}))},!1)},e.smoothy=n}(window);
